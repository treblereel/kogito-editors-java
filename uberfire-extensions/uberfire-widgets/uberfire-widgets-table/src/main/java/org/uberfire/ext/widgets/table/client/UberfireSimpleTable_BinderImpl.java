...
public class UberfireSimpleTable_BinderImpl implements UiBinder<Widget, UberfireSimpleTable>, UberfireSimpleTable.Binder {


  public Widget createAndBindUi(final UberfireSimpleTable owner) {
   ...
   */
  class Widgets {
    private final UberfireSimpleTable owner;


    public Widgets(final UberfireSimpleTable owner) {
      this.owner = owner;
     ...
     */
    private UberfireSimpleTable_BinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private UberfireSimpleTable_BinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final UberfireSimpleTable_BinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = new UberfireSimpleTable_BinderImpl_GenBundle_default_InlineClientBundleGenerator();
      // Setup section.
     ...
     */
    private UberfireSimpleTable_BinderImpl_GenCss_style style;
    private UberfireSimpleTable_BinderImpl_GenCss_style get_style() {
      return style;
    }
    private UberfireSimpleTable_BinderImpl_GenCss_style build_style() {
      // Creation section.
