    ...
    extends JSITDMNElement
{
    ...
    protected JSITArtifact() {
    }

    @JsOverlay
    public static JSITArtifact newInstance() {
        JSITArtifact toReturn = new JSITArtifact();
    ...
    public static JSIName getJSIName() {
        ...
        toReturn.setLocalPart("tArtifact");
        toReturn.setPrefix("");
        toReturn.setKey("{http://www.omg.org/spec/DMN/20180521/MODEL/}");
        toReturn.setString("{http://www.omg.org/spec/DMN/20180521/MODEL/}tArtifact");
        return toReturn;
    }
