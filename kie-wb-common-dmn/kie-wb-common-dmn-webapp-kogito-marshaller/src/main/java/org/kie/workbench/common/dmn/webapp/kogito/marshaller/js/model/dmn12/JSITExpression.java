    ...
    extends JSITDMNElement
{
    ...
    protected JSITExpression() {
    }

    @JsOverlay
    public static JSITExpression newInstance() {
        JSITExpression toReturn = new JSITExpression();
    ...
    public static JSIName getJSIName() {
        ...
        toReturn.setLocalPart("tExpression");
        toReturn.setPrefix("");
        toReturn.setKey("{http://www.omg.org/spec/DMN/20180521/MODEL/}");
        toReturn.setString("{http://www.omg.org/spec/DMN/20180521/MODEL/}tExpression");
        return toReturn;
    }
