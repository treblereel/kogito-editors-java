    ...
    extends JSITDRGElement
{
    ...
    protected JSITInvocable() {
    }

    @JsOverlay
    public static JSITInvocable newInstance() {
        JSITInvocable toReturn = new JSITInvocable();
    ...
    public static JSIName getJSIName() {
        ...
        toReturn.setLocalPart("tInvocable");
        toReturn.setPrefix("");
        toReturn.setKey("{http://www.omg.org/spec/DMN/20180521/MODEL/}");
        toReturn.setString("{http://www.omg.org/spec/DMN/20180521/MODEL/}tInvocable");
        return toReturn;
    }
