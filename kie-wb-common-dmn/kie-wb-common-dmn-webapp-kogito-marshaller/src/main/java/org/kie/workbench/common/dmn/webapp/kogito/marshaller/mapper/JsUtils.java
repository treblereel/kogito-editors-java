     ...
     */
     ...
     private static native void toAttributesMap(final Map<QName, String> toReturn,
        ...
        for (var i = 0; i < keys.length; i++) {
            ...
            @org.kie.workbench.common.dmn.webapp.kogito.marshaller.mapper.JsUtils::putToAttributesMap(Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;)(toReturn, key, value);
        }
    }-*/;
