    ...
    extends JSITDMNElement
{
    ...
    protected JSITNamedElement() {
    }

    @JsOverlay
    public static JSITNamedElement newInstance() {
        JSITNamedElement toReturn = new JSITNamedElement();
    ...
    public static JSIName getJSIName() {
        ...
        toReturn.setLocalPart("tNamedElement");
        toReturn.setPrefix("");
        toReturn.setKey("{http://www.omg.org/spec/DMN/20180521/MODEL/}");
        toReturn.setString("{http://www.omg.org/spec/DMN/20180521/MODEL/}tNamedElement");
        return toReturn;
    }
