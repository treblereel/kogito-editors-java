...
public class JSITRuleAnnotationClause {
    ...
    protected JSITRuleAnnotationClause() {
    }

    @JsOverlay
    public static JSITRuleAnnotationClause newInstance() {
        JSITRuleAnnotationClause toReturn = new JSITRuleAnnotationClause();
    ...
    public static JSIName getJSIName() {
        ...
        toReturn.setLocalPart("tRuleAnnotationClause");
        toReturn.setPrefix("");
        toReturn.setKey("{http://www.omg.org/spec/DMN/20180521/MODEL/}");
        toReturn.setString("{http://www.omg.org/spec/DMN/20180521/MODEL/}tRuleAnnotationClause");
        return toReturn;
    }
